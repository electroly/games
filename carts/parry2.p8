...
function g05_draw()
	...
	for i=-1,1 do
		for j=-1,1 do
			sspr(psx,0,8,8,i+24+g05_flagoffx,7+j+g05_y,
			16,16)
		end
	end
	pal(pal_default)
	sspr(psx,0,8,8,24+g05_flagoffx,7+g05_y,
		16,16)
